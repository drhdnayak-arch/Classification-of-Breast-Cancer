...
1.	General Transform-Invariant Principal Component Analysis (GT-PCA)
2.	Soft Voting Ensemble Learning
3.	Simulated Annealing Stochastic Expectation Maximization (SASEM)
